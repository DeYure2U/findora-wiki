...
# Run a Validator Node in Findora Mainnet

What this document covers:
- How to add your own node to the Findora Network
...
> **Tips**:
>
> If you want to skip this stage and experience the staking operations directly, you can execute this automated script: [**node_init_mainnet.sh**](./node_init_mainnet.sh).
>
...
- trade FRA tokens from exchange [Gate.io](https://www.gate.io/), which is one of the global top 10 cryptocurrency exchanges with authentic trading volume
- ...
